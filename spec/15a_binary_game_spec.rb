  ...
  describe '#player_input' do
    ...
    context 'when user inputs an incorrect value once, then a valid input' do
      before do
        letter = 'g'
        valid = '2'
        allow(game_input).to receive(:gets).and_return(letter, valid)
      end
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        letter2 = 'a'
        valid = '2'
        allow(game_input).to receive(:gets).and_return(letter1, letter2, valid)
      end
  ...
  describe '#verify_input' do
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        ...
        valid_number = 2
        verified_input = game.verify_input(min, max, valid_number)
        expect(verified_input).to eq(valid_number)
      end
    end
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        ...
        max = game.instance_variable_get(:@maximum)
        invalid_input = 22
        verified_input = game.verify_input(min, max, invalid_input)
